export module Types
{
    ...
    export　const　isTypeSchema　=　(value: unknown): value is TypeSchema =>　null !== value　&&　"object" === typeof value　&&　"$ref" in value　&&
        isSchema(value.$ref)　&&　"defines" in value　&&　null !== value.defines　&&　"object" === typeof value.defines　&&
        Object.values(value.defines).every(　i　=>　isDefinition(i)　)　&&　"options" in value　&&　isOutputOptions(value.options);
