...
export namespace Jsonable
{
    ...
    export const stringify = (value: Jsonable, replacer?: ((this: any, key: string, value: any) => any) | (number | string)[] | null, space?: string | number):
    ...
    export const isJsonableObject: EvilType.Validator.IsType<JsonableObject> = EvilType.lazy(() => EvilType.Validator.isDictionaryObject(isJsonable));
    export const isJsonable: EvilType.Validator.IsType<Jsonable> = EvilType.lazy(() => EvilType.Validator.isOr(isJsonableValue, isJsonableArray,
        isJsonableObject));
}
