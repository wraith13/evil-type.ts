...
(function (Type) {
    ...
    Type.arrayElementValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.alphaElementValidatorObject, { type: evil_type_1.EvilType.Validator.isJust("array"), items: Type.isTypeOrRefer, minItems: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isDetailedInteger({ minimum: 0, }, true)), maxItems: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isDetailedInteger({ minimum: 0, }, true)), uniqueItems: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isBoolean), });
    ...
    Type.basicStringTypeValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.commonPropertiesValidatorObject, { type: evil_type_1.EvilType.Validator.isJust("string"),
        minLength: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isDetailedInteger({ minimum: 0, }, true)), maxLength: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isDetailedInteger({ minimum: 0, }, true)), default: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isString), });
