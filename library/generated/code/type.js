...
(function (Type) {
    ...
    Type.isBaseNumberType = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isSpecificObject(Type.baseNumberTypeValidatorObject, false); });
    Type.isNumberTypeMM = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isSpecificObject(Type.numberTypeMMValidatorObject, false); });
    Type.isNumberTypeME = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isSpecificObject(Type.numberTypeMEValidatorObject, false); });
    Type.isNumberTypeEM = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isSpecificObject(Type.numberTypeEMValidatorObject, false); });
    Type.isNumberTypeEE = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isSpecificObject(Type.numberTypeEEValidatorObject, false); });
    Type.isNumberType = evil_type_1.EvilType.lazy(function () { return evil_type_1.EvilType.Validator.isOr(Type.isNumberTypeMM, Type.isNumberTypeME, Type.isNumberTypeEM, Type.isNumberTypeEE); });
    ...
    Type.baseNumberTypeValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.commonPropertiesValidatorObject, { type: evil_type_1.EvilType.Validator.isJust("number"),
        multipleOf: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), safeNumber: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isBoolean), });
    Type.numberTypeMMValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.baseNumberTypeValidatorObject, { minimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), exclusiveMinimum: {
            "$type": "never-type-guard"
        }, maximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), exclusiveMaximum: {
            "$type": "never-type-guard"
        }, });
    Type.numberTypeMEValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.baseNumberTypeValidatorObject, { minimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), exclusiveMinimum: {
            "$type": "never-type-guard"
        }, maximum: { "$type": "never-type-guard" }, exclusiveMaximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), });
    Type.numberTypeEMValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.baseNumberTypeValidatorObject, { minimum: { "$type": "never-type-guard" }, exclusiveMinimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), maximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), exclusiveMaximum: {
            "$type": "never-type-guard"
        }, });
    Type.numberTypeEEValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.baseNumberTypeValidatorObject, { minimum: { "$type": "never-type-guard" }, exclusiveMinimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), maximum: { "$type": "never-type-guard" }, exclusiveMaximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), });
    Type.integerTypeValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.commonPropertiesValidatorObject, { type: evil_type_1.EvilType.Validator.isJust("integer"), minimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isInteger), exclusiveMinimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isInteger), maximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isInteger), exclusiveMaximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isInteger), multipleOf: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isInteger), safeInteger: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isBoolean), });
