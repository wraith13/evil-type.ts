...
(function (Type) {
    ...
    Type.numberTypeValidatorObject = evil_type_1.EvilType.Validator.mergeObjectValidator(Type.commonPropertiesValidatorObject, { type: evil_type_1.EvilType.Validator.isJust("number"), minimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isInteger), exclusiveMinimum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), maximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), exclusiveMaximum: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), multipleOf: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isNumber), safeNumber: evil_type_1.EvilType.Validator.isOptional(evil_type_1.EvilType.Validator.isBoolean), });
