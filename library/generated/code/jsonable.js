...
(function (Jsonable) {
    ...
    Jsonable.isJsonableValue = validator_1.EvilTypeValidator.isOr(validator_1.EvilTypeValidator.isNull, validator_1.EvilTypeValidator.isBoolean, validator_1.EvilTypeValidator.isNumber, validator_1.EvilTypeValidator.isString);
    Jsonable.isJsonableArray = function (value, listner) {
        return validator_1.EvilTypeValidator.isArray(Jsonable.isJsonable)(value, listner);
    };
